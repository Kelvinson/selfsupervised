...
from ss.algos.replay_buffer import ReplayBuffer, HERBuffer, InverseBuffer
...
class InverseModel(object):
    def __init__(self, **params):
        ...
        self.memory = InverseBuffer(limit=int(self.buffer_size),
        ...
        e = (self.actor_tf * self.max_action) - self.actions
        self.actor_loss = tf.reduce_mean(tf.square(e))

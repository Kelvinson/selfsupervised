...
def parse_args():
    ...
    parser.add_argument('--datasource', type=str, default="boxenv_random", help='Data source')
...
def main(args):
    ...
    train_total_data, test_data, test_labels = box_env_data.get_data(args.datasource)
    n_samples = len(train_total_data)
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(n_epochs):
            ...
            for i in range(total_batch):
                ...
                if np.isnan(loss_divergence):
                    pdb.set_trace()
                # print(i, tot_loss, loss_likelihood, loss_divergence)
